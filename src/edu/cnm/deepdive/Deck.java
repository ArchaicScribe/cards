...
/**
 * <code>Deck</code> implements a single deck of standard playing cards. Methods are included for
 * shuffling and dealing cards from the deck.
 *
...
public class Deck {
 ...
 public Deck() {
   ...
   *
   * @param rng <strong>strong</strong> source of randomness.
   */
 ...
 public void shuffle(Random rng){
  ...
  /**
   * Deals and return one card from the top of the pile.If no cards are in the pile, a {@link
   * DeckEmptyException} will be thrown.
   *
 ...
 public Card deal() throws DeckEmptyException {
  ...
  /**
   * This exception is thrown when {@link #deal()} in invoked on an empty deck.
   */
